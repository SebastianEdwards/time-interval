  ...
  describe '.parse' do
    context 'iso8601 is a valid time pair' do
      ...
      it 'should have correct end_time' do
        ...
        expect(result.end_time).to eq DateTime.parse('2008-05-11T15:30:00Z')
      end
    end
  end

  describe '#iso8601' do
    let(:first_time) { DateTime.parse('2007-03-01T13:00:00Z') }
    let(:last_time) { DateTime.parse('2008-05-11T15:30:00Z') }
